...
$url        = 'http://cdn.gxx.garenanow.com/gxx/pc/installer/Garena-v2.0.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'garena*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
